...
% Trim image so that blocks evenly cover it
M = M1(1:cut1,1:cut2);

% Cut matrix into blocks
...
% Flatten matrix of blocks into list of vectors
...
% Also return smallest dimenson of block matrix (the max rank)
